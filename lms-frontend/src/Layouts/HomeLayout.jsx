    ...
    <div className="min-h-[90vh] bg-black">
      <div className="drawer absolute left-0 z-50 w-fit">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-48 sm:w-80 bg-base-600 text-base-content relative min-h-[100vh] bg-[#00000008] backdrop-blur-md text-white">
              ...
              <li className="absolute bottom-0 w-[100%]">
                <div className="w-full flex items-center justify-start my-3">
                  <button className="bg-[#F1CD85] px-4 py-2 w-1/3 text-black font-bold">
                    <Link className="p-0 h-fit" to="/login">
                      Login
                    </Link>
                  </button>
            ...
            {isLoggedIn && (
              <li className="absolute  left-0 bottom-0 w-[100%]">
                ...
                <div className="w-full flex items-center justify-center my-3"></div>
              </li>
            )}
          </ul>
        </div>
